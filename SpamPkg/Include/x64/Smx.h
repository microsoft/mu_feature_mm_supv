...
// TODO: TBD here
#define SPAM_EVTYPE_MM_ENTRY_HASH        (TXT_EVTYPE_BASE + 21)
#define SPAM_EVTYPE_MM_CORE_HASH         (TXT_EVTYPE_BASE + 22)
#define SPAM_EVTYPE_MM_USER_MODULE_HASH  (TXT_EVTYPE_BASE + 23)
