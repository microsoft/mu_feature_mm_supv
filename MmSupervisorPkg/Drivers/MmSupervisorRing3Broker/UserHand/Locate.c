  ...
  )
{
  ...
  *Interface = NULL;
  ...
  if (Registration == NULL) {
    ...
    //
    Position.ProtEntry = MmFindUserProtocolEntry (Protocol, FALSE);
...
/**
  ...
  in a buffer allocated from pool. This is a version of MmLocateHandleUser()
  ...
  )
{
  ...
  *Buffer        = NULL;
  ...
  // invalid.
  //
  // Add code to correctly handle expected errors from MmLocateHandleUser().
  //
  ...
  MmAllocateUserPool (EfiRuntimeServicesData, BufferSize, (VOID **)Buffer);
  if (*Buffer == NULL) {
