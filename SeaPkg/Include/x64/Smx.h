...
// TODO: TBD here
#define SEA_EVTYPE_MM_ENTRY_HASH        (TXT_EVTYPE_BASE + 21)
#define SEA_EVTYPE_MM_CORE_HASH         (TXT_EVTYPE_BASE + 22)
#define SEA_EVTYPE_MM_USER_MODULE_HASH  (TXT_EVTYPE_BASE + 23)
