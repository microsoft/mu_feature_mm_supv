  ...
  )
{
  ...
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_N_GUEST_CR0_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_CR0_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_N_GUEST_CR3_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_CR3_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_N_GUEST_CR4_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_CR4_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_N_GUEST_DR7_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_DR7_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_N_GUEST_RSP_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_RSP_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_N_GUEST_RIP_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_RIP_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_N_GUEST_RFLAGS_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_RFLAGS_INDEX)));

  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_64_GUEST_IA32_DEBUGCTL_INDEX: %08x\n", (UINTN)VmRead64 (VMCS_64_GUEST_IA32_DEBUGCTL_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_N_GUEST_IA32_SYSENTER_ESP_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_IA32_SYSENTER_ESP_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_N_GUEST_IA32_SYSENTER_EIP_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_IA32_SYSENTER_EIP_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_64_GUEST_IA32_EFER_INDEX: %08x\n", (UINTN)VmRead64 (VMCS_64_GUEST_IA32_EFER_INDEX)));

  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_16_GUEST_ES_INDEX: %04x\n", (UINTN)VmRead16 (VMCS_16_GUEST_ES_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_16_GUEST_CS_INDEX: %04x\n", (UINTN)VmRead16 (VMCS_16_GUEST_CS_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_16_GUEST_SS_INDEX: %04x\n", (UINTN)VmRead16 (VMCS_16_GUEST_SS_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_16_GUEST_DS_INDEX: %04x\n", (UINTN)VmRead16 (VMCS_16_GUEST_DS_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_16_GUEST_FS_INDEX: %04x\n", (UINTN)VmRead16 (VMCS_16_GUEST_FS_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_16_GUEST_GS_INDEX: %04x\n", (UINTN)VmRead16 (VMCS_16_GUEST_GS_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_16_GUEST_LDTR_INDEX: %04x\n", (UINTN)VmRead16 (VMCS_16_GUEST_LDTR_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_16_GUEST_TR_INDEX: %04x\n", (UINTN)VmRead16 (VMCS_16_GUEST_TR_INDEX)));

  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_32_GUEST_ES_LIMIT_INDEX: %08x\n", (UINTN)VmRead32 (VMCS_32_GUEST_ES_LIMIT_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_32_GUEST_CS_LIMIT_INDEX: %08x\n", (UINTN)VmRead32 (VMCS_32_GUEST_CS_LIMIT_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_32_GUEST_SS_LIMIT_INDEX: %08x\n", (UINTN)VmRead32 (VMCS_32_GUEST_SS_LIMIT_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_32_GUEST_DS_LIMIT_INDEX: %08x\n", (UINTN)VmRead32 (VMCS_32_GUEST_DS_LIMIT_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_32_GUEST_FS_LIMIT_INDEX: %08x\n", (UINTN)VmRead32 (VMCS_32_GUEST_FS_LIMIT_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_32_GUEST_GS_LIMIT_INDEX: %08x\n", (UINTN)VmRead32 (VMCS_32_GUEST_GS_LIMIT_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_32_GUEST_LDTR_LIMIT_INDEX: %08x\n", (UINTN)VmRead32 (VMCS_32_GUEST_LDTR_LIMIT_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_32_GUEST_TR_LIMIT_INDEX: %08x\n", (UINTN)VmRead32 (VMCS_32_GUEST_TR_LIMIT_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_32_GUEST_GDTR_LIMIT_INDEX: %08x\n", (UINTN)VmRead32 (VMCS_32_GUEST_GDTR_LIMIT_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_32_GUEST_IDTR_LIMIT_INDEX: %08x\n", (UINTN)VmRead32 (VMCS_32_GUEST_IDTR_LIMIT_INDEX)));

  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_N_GUEST_ES_BASE_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_ES_BASE_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_N_GUEST_CS_BASE_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_CS_BASE_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_N_GUEST_SS_BASE_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_SS_BASE_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_N_GUEST_DS_BASE_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_DS_BASE_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_N_GUEST_FS_BASE_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_FS_BASE_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_N_GUEST_GS_BASE_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_GS_BASE_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_N_GUEST_LDTR_BASE_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_LDTR_BASE_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_N_GUEST_TR_BASE_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_TR_BASE_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_N_GUEST_GDTR_BASE_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_GDTR_BASE_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_N_GUEST_IDTR_BASE_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_IDTR_BASE_INDEX)));

  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_32_GUEST_ES_ACCESS_RIGHT_INDEX: %08x\n",   (UINTN)VmRead32 (VMCS_32_GUEST_ES_ACCESS_RIGHT_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_32_GUEST_CS_ACCESS_RIGHT_INDEX: %08x\n",   (UINTN)VmRead32 (VMCS_32_GUEST_CS_ACCESS_RIGHT_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_32_GUEST_SS_ACCESS_RIGHT_INDEX: %08x\n",   (UINTN)VmRead32 (VMCS_32_GUEST_SS_ACCESS_RIGHT_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_32_GUEST_DS_ACCESS_RIGHT_INDEX: %08x\n",   (UINTN)VmRead32 (VMCS_32_GUEST_DS_ACCESS_RIGHT_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_32_GUEST_FS_ACCESS_RIGHT_INDEX: %08x\n",   (UINTN)VmRead32 (VMCS_32_GUEST_FS_ACCESS_RIGHT_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_32_GUEST_GS_ACCESS_RIGHT_INDEX: %08x\n",   (UINTN)VmRead32 (VMCS_32_GUEST_GS_ACCESS_RIGHT_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_32_GUEST_LDTR_ACCESS_RIGHT_INDEX: %08x\n",   (UINTN)VmRead32 (VMCS_32_GUEST_LDTR_ACCESS_RIGHT_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_32_GUEST_TR_ACCESS_RIGHT_INDEX: %08x\n",   (UINTN)VmRead32 (VMCS_32_GUEST_TR_ACCESS_RIGHT_INDEX)));

  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_32_CONTROL_PROCESSOR_BASED_VM_EXECUTION_INDEX: %08x\n",   (UINTN)VmRead32 (VMCS_32_CONTROL_PROCESSOR_BASED_VM_EXECUTION_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_32_CONTROL_2ND_PROCESSOR_BASED_VM_EXECUTION_INDEX: %08x\n",   (UINTN)VmRead32 (VMCS_32_CONTROL_2ND_PROCESSOR_BASED_VM_EXECUTION_INDEX)));

  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_32_GUEST_INTERRUPTIBILITY_STATE_INDEX: %08x\n",   (UINTN)VmRead32 (VMCS_32_GUEST_INTERRUPTIBILITY_STATE_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_32_GUEST_ACTIVITY_STATE_INDEX: %08x\n",   (UINTN)VmRead32 (VMCS_32_GUEST_ACTIVITY_STATE_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_N_GUEST_PENDING_DEBUG_EXCEPTIONS_INDEX: %08x\n",   (UINTN)VmReadN (VMCS_N_GUEST_PENDING_DEBUG_EXCEPTIONS_INDEX)));
  DEBUG ((EFI_D_ERROR, "On exit Guest-state VMCS_64_GUEST_VMCS_LINK_PTR_INDEX: %08x\n",   (UINTN)VmRead64 (VMCS_64_GUEST_VMCS_LINK_PTR_INDEX)));

  DEBUG ((EFI_D_ERROR, "On Exit MSR IA32_VMX_CR0_FIXED0_MSR_INDEX: %08x\n",   (UINTN)AsmReadMsr64 (IA32_VMX_CR0_FIXED0_MSR_INDEX)));
  DEBUG ((EFI_D_ERROR, "On Exit MSR IA32_VMX_CR0_FIXED1_MSR_INDEX: %08x\n",   (UINTN)AsmReadMsr64 (IA32_VMX_CR0_FIXED1_MSR_INDEX)));
  DEBUG ((EFI_D_ERROR, "On Exit MSR IA32_VMX_CR4_FIXED0_MSR_INDEX: %08x\n",   (UINTN)AsmReadMsr64 (IA32_VMX_CR4_FIXED0_MSR_INDEX)));
  DEBUG ((EFI_D_ERROR, "On Exit MSR IA32_VMX_CR4_FIXED1_MSR_INDEX: %08x\n",   (UINTN)AsmReadMsr64 (IA32_VMX_CR4_FIXED1_MSR_INDEX)));
  ...
  )
{
  ...
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_16_GUEST_ES_INDEX: %04x\n", (UINTN)VmRead16 (VMCS_16_GUEST_ES_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_16_GUEST_CS_INDEX: %04x\n", (UINTN)VmRead16 (VMCS_16_GUEST_CS_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_16_GUEST_SS_INDEX: %04x\n", (UINTN)VmRead16 (VMCS_16_GUEST_SS_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_16_GUEST_DS_INDEX: %04x\n", (UINTN)VmRead16 (VMCS_16_GUEST_DS_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_16_GUEST_FS_INDEX: %04x\n", (UINTN)VmRead16 (VMCS_16_GUEST_FS_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_16_GUEST_GS_INDEX: %04x\n", (UINTN)VmRead16 (VMCS_16_GUEST_GS_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_16_GUEST_LDTR_INDEX: %04x\n", (UINTN)VmRead16 (VMCS_16_GUEST_LDTR_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_16_GUEST_TR_INDEX: %04x\n", (UINTN)VmRead16 (VMCS_16_GUEST_TR_INDEX)));

  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_32_GUEST_ES_LIMIT_INDEX: %08x\n", (UINTN)VmRead32 (VMCS_32_GUEST_ES_LIMIT_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_32_GUEST_CS_LIMIT_INDEX: %08x\n", (UINTN)VmRead32 (VMCS_32_GUEST_CS_LIMIT_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_32_GUEST_SS_LIMIT_INDEX: %08x\n", (UINTN)VmRead32 (VMCS_32_GUEST_SS_LIMIT_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_32_GUEST_DS_LIMIT_INDEX: %08x\n", (UINTN)VmRead32 (VMCS_32_GUEST_DS_LIMIT_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_32_GUEST_FS_LIMIT_INDEX: %08x\n", (UINTN)VmRead32 (VMCS_32_GUEST_FS_LIMIT_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_32_GUEST_GS_LIMIT_INDEX: %08x\n", (UINTN)VmRead32 (VMCS_32_GUEST_GS_LIMIT_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_32_GUEST_LDTR_LIMIT_INDEX: %08x\n", (UINTN)VmRead32 (VMCS_32_GUEST_LDTR_LIMIT_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_32_GUEST_TR_LIMIT_INDEX: %08x\n", (UINTN)VmRead32 (VMCS_32_GUEST_TR_LIMIT_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_32_GUEST_GDTR_LIMIT_INDEX: %08x\n", (UINTN)VmRead32 (VMCS_32_GUEST_GDTR_LIMIT_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_32_GUEST_IDTR_LIMIT_INDEX: %08x\n", (UINTN)VmRead32 (VMCS_32_GUEST_IDTR_LIMIT_INDEX)));

  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_N_GUEST_ES_BASE_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_ES_BASE_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_N_GUEST_CS_BASE_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_CS_BASE_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_N_GUEST_SS_BASE_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_SS_BASE_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_N_GUEST_DS_BASE_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_DS_BASE_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_N_GUEST_FS_BASE_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_FS_BASE_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_N_GUEST_GS_BASE_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_GS_BASE_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_N_GUEST_LDTR_BASE_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_LDTR_BASE_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_N_GUEST_TR_BASE_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_TR_BASE_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_N_GUEST_GDTR_BASE_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_GDTR_BASE_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_N_GUEST_IDTR_BASE_INDEX: %08x\n", (UINTN)VmReadN (VMCS_N_GUEST_IDTR_BASE_INDEX)));

  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_32_GUEST_ES_ACCESS_RIGHT_INDEX: %08x\n",   (UINTN)VmRead32 (VMCS_32_GUEST_ES_ACCESS_RIGHT_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_32_GUEST_CS_ACCESS_RIGHT_INDEX: %08x\n",   (UINTN)VmRead32 (VMCS_32_GUEST_CS_ACCESS_RIGHT_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_32_GUEST_SS_ACCESS_RIGHT_INDEX: %08x\n",   (UINTN)VmRead32 (VMCS_32_GUEST_SS_ACCESS_RIGHT_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_32_GUEST_DS_ACCESS_RIGHT_INDEX: %08x\n",   (UINTN)VmRead32 (VMCS_32_GUEST_DS_ACCESS_RIGHT_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_32_GUEST_FS_ACCESS_RIGHT_INDEX: %08x\n",   (UINTN)VmRead32 (VMCS_32_GUEST_FS_ACCESS_RIGHT_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_32_GUEST_GS_ACCESS_RIGHT_INDEX: %08x\n",   (UINTN)VmRead32 (VMCS_32_GUEST_GS_ACCESS_RIGHT_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_32_GUEST_LDTR_ACCESS_RIGHT_INDEX: %08x\n",   (UINTN)VmRead32 (VMCS_32_GUEST_LDTR_ACCESS_RIGHT_INDEX)));
  DEBUG ((EFI_D_ERROR, "Guest-state VMCS_32_GUEST_TR_ACCESS_RIGHT_INDEX: %08x\n",   (UINTN)VmRead32 (VMCS_32_GUEST_TR_ACCESS_RIGHT_INDEX)));

  DEBUG ((EFI_D_ERROR, "MSR IA32_VMX_CR0_FIXED0_MSR_INDEX: %08x\n",   (UINTN)AsmReadMsr64 (IA32_VMX_CR0_FIXED0_MSR_INDEX)));
  DEBUG ((EFI_D_ERROR, "MSR IA32_VMX_CR0_FIXED1_MSR_INDEX: %08x\n",   (UINTN)AsmReadMsr64 (IA32_VMX_CR0_FIXED1_MSR_INDEX)));
