...
use crate::aux_file::{AuxFile, ImageValidationEntryHeader};
...
impl SegmentList {
    ...
    pub fn add_segments_from_aux_entries(&mut self, entries: &[ImageValidationEntryHeader], metadata: &mut PdbMetadata) -> Result<()> {
